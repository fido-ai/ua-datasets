...
def validate(txt_path: str = "ua_squad_dataset.txt", show_warnings: bool = False):
    class Keyword(Enum):
        Context = 1
        Question = 2
        Answer = 3
...
# txt file should be valid(see validate function above) in order to get a proper result
